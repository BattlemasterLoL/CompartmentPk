...
def run_simulation():
    try:
        ...
        if is_square(m) and is_square(m.T):
            ...
            messagebox.showerror("Error", "Please enter a square matrix for m.")
            return
...
frame_compartments = ttk.LabelFrame(frame_main, padding="10", text="Compartments")
...
frame_y0_vector = ttk.LabelFrame(frame_main, padding="10", text="Initial Conditions")
